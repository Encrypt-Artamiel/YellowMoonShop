...
public class SearchProductServlet extends HttpServlet {
    ...
    private final Logger LOG = Logger.getLogger(SearchProductServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String choosenPrice = request.getParameter("price");
            String[] price = choosenPrice.split(":");
            ...
            productDAO.searchProduct(searchValue, minPrice, maxPrice, categoryID, currentPage - 1);
            List<ProductDTO> listProduct = productDAO.getList();
